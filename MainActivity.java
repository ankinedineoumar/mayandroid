package com.example.adoka.meteoapp;
...
import com.example.adoka.meteoapp.Data.Channel;
import com.example.adoka.meteoapp.Data.Condition;
import com.example.adoka.meteoapp.Data.Item;
import com.example.adoka.meteoapp.Data.LocationResult;
import com.example.adoka.meteoapp.Data.Units;
import com.example.adoka.meteoapp.Fragments.MeteoConditionFragment;
import com.example.adoka.meteoapp.Listener.GeocodingServiceListener;
import com.example.adoka.meteoapp.Listener.MeteoServiceListener;
import com.example.adoka.meteoapp.Service.GoogleMapsGeocodingService;
import com.example.adoka.meteoapp.Service.MeteoCacheService;
import com.example.adoka.meteoapp.Service.MeteoServiceCallback;
import com.example.adoka.meteoapp.Service.YahooMeteoService;

public abstract class MainActivity extends AppCompatActivity implements MeteoServiceListener, GeocodingServiceListener, LocationListener {

    public static int GET_WEATHER_FROM_CURRENT_LOCATION = 0x00001;

    private ImageView meteoIconImage;
    private ImageView meteoLogo;
    private TextView temperatureIconText;
    private TextView conditionIconText;
    private TextView locationIconText;

    private YahooMeteoService weatherService;
    private GoogleMapsGeocodingService geocodingService;
    private MeteoCacheService cacheService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meteoIconImage = (ImageView) findViewById(R.id.iconMeteo);
        temperatureIconText = (TextView) findViewById(R.id.temperatureTextView);
        conditionIconText = (TextView) findViewById(R.id.conditionTextView);
        locationIconText = (TextView) findViewById(R.id.locationTextView);

        preferences = PreferenceManager.getDefaultSharedPreferences(this);

        weatherService = new YahooMeteoService(this);
        ...
        cacheService = new MeteoCacheService(this);
    ...
    protected void onStart() {
        ...
        if (location != null) {
            weatherService.refreshMeteo(location);
        }
    }
    ...
    public void serviceSuccess(Channel channel) {
        ...
        meteoIconImage.setImageResource(weatherIconImageResource);
        temperatureIconText.setText(getString(R.string.temperature_output, condition.getTemperature(), units.getTemperature()));
        conditionIconText.setText(condition.getDescription());
        locationIconText.setText(channel.getLocation());
    ...
    public void geocodeSuccess(LocationResult location) {
        ...
        weatherService.refreshMeteo(location.getAddress());
